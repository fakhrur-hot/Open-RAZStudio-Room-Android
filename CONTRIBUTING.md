...
- Fork this repository "StudioRoom" by clicking on the "Fork" button. This will create a local copy of this respository on your GitHub profile.
...
```bash
git clone https://github.com/<your-username>/<StudioRoom>  
```
...
```bash  
cd <repo-name>  
git remote add upstream https://github.com/<upstream-owner>/<StudioRoom>
