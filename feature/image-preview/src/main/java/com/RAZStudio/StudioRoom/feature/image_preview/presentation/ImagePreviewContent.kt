...
package com.RAZStudio.StudioRoom.feature.image_preview.presentation
...
import com.RAZStudio.StudioRoom.core.ui.widget.controls.SortButton
import com.RAZStudio.StudioRoom.core.ui.widget.dialogs.ExitBackHandler
...
import com.RAZStudio.StudioRoom.core.ui.widget.image.ImagePreviewGrid
...
import com.RAZStudio.StudioRoom.core.utils.sortedByType
                ...
                topBar = {
                    EnhancedTopAppBar(
                        ...
                        actions = {
                            ...
                            // Requirement 16.1 — "Add to project", alongside the
                            // existing edit and share actions.
                            //
                            // Navigates to Screen.AddToProject rather than
                            // showing a picker here, so this module needs no
                            // database dependency merely to list projects
                            // (Requirement 16.24).
                            AnimatedVisibility(
                                // Available whenever there is anything to add,
                                ...
                                EnhancedIconButton(
                                    onClick = {
                                        // Selection wins when the user made one;
                                        // otherwise everything on screen.
                                        component.onNavigate(
                                            Screen.AddToProject(
                                                uris = selectedUris.ifEmpty {
                                                    component.uris.orEmpty()
                                                }
                                            )
                                        )
                                    }
