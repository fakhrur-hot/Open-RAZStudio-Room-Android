...
package com.RAZStudio.StudioRoom.feature.settings.data.keys
...
internal fun Preferences.toSettingsState(
    ...
    defaultResizeSharpen = this[RESIZE_SHARPEN]?.let { ordinal ->
        ResizeSharpen.entries.getOrNull(ordinal)
    } ?: default.defaultResizeSharpen,
    ...
    isDebugMode = this[DEBUG_MODE] ?: BuildConfig.DEBUG,
    rawDemosaicAlgorithm = this[RAW_DEMOSAIC_ALGORITHM] ?: default.rawDemosaicAlgorithm,
    letterboxColor = this[LETTERBOX_COLOR]?.let { ColorModel(it) } ?: default.letterboxColor,
)
