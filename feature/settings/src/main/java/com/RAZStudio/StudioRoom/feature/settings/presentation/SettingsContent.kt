...
package com.RAZStudio.StudioRoom.feature.settings.presentation
...
import com.RAZStudio.StudioRoom.core.ui.theme.blend
...
import com.RAZStudio.StudioRoom.core.ui.widget.enhanced.EnhancedTopAppBarDefaults
...
import com.RAZStudio.StudioRoom.core.ui.widget.other.SearchBar
...
import com.RAZStudio.StudioRoom.core.ui.widget.text.isKeyboardVisibleAsState
...
import com.RAZStudio.StudioRoom.feature.settings.presentation.components.SearchableSettingItem
import com.RAZStudio.StudioRoom.feature.settings.presentation.components.SettingGroupItem
import com.RAZStudio.StudioRoom.feature.settings.presentation.components.SettingItem
            ...
            AnimatedContent(
                ...
                if (settingsAnimated == null) {
                    LazyVerticalStaggeredGrid(
                        ...
                        // ── Features section ────────────────────────────────────────
                        // Mirrors the modifier + color used by SettingGroupItem so the
                        // Features card has the same width and tint as the other groups.
                        item(
                            key = "features_section",
                            span = StaggeredGridItemSpan.FullLine,
                        ) {
                            com.RAZStudio.StudioRoom.core.ui.widget.other.ExpandableItem(
                                modifier = Modifier
                                    .fillMaxWidth()
                                    .padding(2.dp),
                                color = com.RAZStudio.StudioRoom.core.ui.theme.takeColorFromScheme {
                                    surfaceContainer.blend(surfaceContainerLowest, 0.4f)
                                },
                                visibleContent = {
                                    com.RAZStudio.StudioRoom.core.ui.widget.text.TitleItem(
                                        modifier = Modifier.padding(start = 8.dp),
                                        icon = com.RAZStudio.StudioRoom.core.resources.Icons.Outlined.ServiceToolbox,
                                        text = stringResource(com.RAZStudio.StudioRoom.core.resources.R.string.features)
                                    )
                                },
                                expandableContent = {
                                    Column(
                                        ...
                                        Screen.hiddenFromMain.forEach { screen ->
                                            Text(
