...
package com.RAZStudio.StudioRoom.feature.settings.presentation.screenLogic
...
import com.RAZStudio.dynamic.theme.extractPrimaryColor
...
import com.RAZStudio.StudioRoom.core.domain.utils.humanFileSize
...
import com.RAZStudio.StudioRoom.core.settings.presentation.model.Setting
import com.RAZStudio.StudioRoom.core.settings.presentation.model.SettingsGroup
import com.RAZStudio.StudioRoom.core.settings.presentation.model.UiFontFamily
...
class SettingsComponent @AssistedInject internal constructor(
    ...
    fun setDefaultResizeSharpen(resizeSharpen: ResizeSharpen) =
        settingsScope { setDefaultResizeSharpen(resizeSharpen) }
    ...
    fun toggleDebugMode() =
        settingsScope { toggleDebugMode() }

    fun toggleEnableBackgroundColorForAlphaFormats() =
        settingsScope { toggleEnableBackgroundColorForAlphaFormats() }

    fun setRawDemosaicAlgorithm(algorithm: String) =
        settingsScope { setRawDemosaicAlgorithm(algorithm) }

    fun setLetterboxColor(colorModel: ColorModel) =
        settingsScope { setLetterboxColor(colorModel) }
