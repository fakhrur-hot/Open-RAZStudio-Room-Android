...
import com.RAZStudio.StudioRoom.core.resources.icons.TextFields
        ...
        when (setting) {
            ...
            Setting.DefaultScaleMode -> {
                DefaultScaleModeSettingItem(
                    onValueChange = component::setDefaultImageScaleMode,
                    onResizeSharpenChange = component::setDefaultResizeSharpen,
                )
            }
            ...
            Setting.DebugMode -> {
                DebugModeSettingItem(onClick = component::toggleDebugMode)
            }

            Setting.RawDemosaicAlgorithm -> {
                RawDemosaicAlgorithmSettingItem(onValueChange = component::setRawDemosaicAlgorithm)
            }

            Setting.LetterboxColor -> {
                LetterboxColorSettingItem(onValueChange = component::setLetterboxColor)
            }

            Setting.BatchScreenProtection -> BatchScreenProtectionSettingItem()
            Setting.BatchBrightness       -> BatchBrightnessSettingItem()
            Setting.BatchMusicEnabled     -> BatchMusicEnabledSettingItem()
            Setting.BatchMusicVolume      -> BatchMusicVolumeSettingItem()
        }
    }
}