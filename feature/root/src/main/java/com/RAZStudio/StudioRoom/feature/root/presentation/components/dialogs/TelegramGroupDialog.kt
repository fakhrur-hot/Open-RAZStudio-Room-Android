...
import com.RAZStudio.StudioRoom.core.domain.TELEGRAM_CHANNEL_LINK
import com.RAZStudio.StudioRoom.core.domain.TELEGRAM_GROUP_LINK
import com.RAZStudio.StudioRoom.core.resources.R
import com.RAZStudio.StudioRoom.core.resources.icons.Cancel
...
fun TelegramGroupDialog(
    ...
    EnhancedAlertDialog(
        ...
        title = {
            Text(stringResource(R.string.studio_room_in_telegram))
        },
        text = {
            Text(stringResource(R.string.studio_room_in_telegram_sub))
        },
        confirmButton = {
            EnhancedButton(
                onClick = {
