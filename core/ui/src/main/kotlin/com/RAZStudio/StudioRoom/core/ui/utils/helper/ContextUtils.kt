...
import com.RAZStudio.StudioRoom.core.ui.utils.helper.image_vector.toImageBitmap
...
import com.RAZStudio.StudioRoom.core.ui.utils.permission.PermissionUtils.askUserToRequestPermissionExplicitly
...
import com.RAZStudio.StudioRoom.core.ui.utils.permission.PermissionUtils.setPermissionsAllowed
import com.RAZStudio.StudioRoom.core.ui.widget.other.ToastDuration
...
object ContextUtils {
    ...
    suspend fun Activity.requestStoragePermission() = requestPermissions(
        permissions = listOf(
    ...
    suspend fun Activity.requestPermissions(permissions: List<String>) {
    ...
    suspend fun Context.needToShowStoragePermissionRequest(): Boolean {
