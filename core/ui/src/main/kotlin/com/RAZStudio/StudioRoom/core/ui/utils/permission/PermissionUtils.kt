...
package com.RAZStudio.StudioRoom.core.ui.utils.permission
...
object PermissionUtils {
    ...
    suspend fun Context.checkPermissions(
    ...
    suspend fun Context.setPermissionsAllowed(permissions: List<String>) {
        permissions.forEach { permission ->
...
private class PermissionPreference(private val context: Context) {
    ...
    private suspend fun <T> get(
        ...
        return context.dataStore.edit {}[key] ?: default
    }
    ...
    suspend fun setPermissionAllowed(permission: String) {
        context.dataStore.edit {
