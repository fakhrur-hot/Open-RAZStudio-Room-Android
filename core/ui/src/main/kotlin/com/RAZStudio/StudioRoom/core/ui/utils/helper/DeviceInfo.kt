...
import com.RAZStudio.StudioRoom.core.resources.BuildConfig.FLAVOR
import com.RAZStudio.StudioRoom.core.resources.BuildConfig.VERSION_CODE
...
data class DeviceInfo private constructor(
    ...
    companion object {
        fun get(): DeviceInfo {
            val device = "${DeviceIdentityOverride.model} (${DeviceIdentityOverride.brand} - ${DeviceIdentityOverride.device})"
        ...
        fun isInfinix() = getAsString().contains(
            other = "infinix",
            ignoreCase = true
        )
    }
