...
sealed class ImageScaleMode(val value: Int) {
    ...
    /** libresize-powered high-quality downscale. Only valid when output < original. */
    object RAZSharp : ImageScaleMode(-4) {
        override val scaleColorSpace: ScaleColorSpace
            get() = ScaleColorSpace.Default

        override fun copy(
            scaleColorSpace: ScaleColorSpace
        ): ImageScaleMode = RAZSharp

        override fun toString(): String = "RAZSharp"
    }
    ...
    companion object {
        val Default = EwaLanczos4Sharpest()
...
val ImageScaleMode.title: Int
    get() = when (this) {
        ...
        ImageScaleMode.RAZSharp -> R.string.razsharp
