...
interface SettingsInteractor : SimpleSettingsInteractor {
    ...
    suspend fun setDefaultResizeSharpen(resizeSharpen: ResizeSharpen)
    ...
    suspend fun setRawDemosaicAlgorithm(algorithm: String)

    suspend fun setLetterboxColor(color: ColorModel)
