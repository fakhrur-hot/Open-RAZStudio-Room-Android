...
sealed class Setting(
    ...
    data object Threads : Setting(
        title = R.string.threads_follow,
        subtitle = R.string.threads_follow_sub
    )
    ...
    data object DebugMode : Setting(
        title = R.string.debug_mode,
        subtitle = R.string.debug_mode_sub,
    )

    data object RawDemosaicAlgorithm : Setting(
        title = R.string.raw_demosaic,
        subtitle = R.string.raw_demosaic_sub,
    )

    data object LetterboxColor : Setting(
        title = R.string.letterbox_color,
        subtitle = R.string.letterbox_color_sub,
    )

    data object BatchScreenProtection : Setting(
        title = R.string.batch_screen_protection,
        subtitle = R.string.batch_screen_protection_sub,
    )

    data object BatchBrightness : Setting(
        title = R.string.batch_brightness,
        subtitle = R.string.batch_brightness_sub,
    )

    data object BatchMusicEnabled : Setting(
        title = R.string.batch_music_enabled,
        subtitle = R.string.batch_music_enabled_sub,
    )

    data object BatchMusicVolume : Setting(
        title = R.string.batch_music_volume,
        subtitle = R.string.batch_music_volume_sub,
    )
